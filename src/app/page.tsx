      ...
      <header className="flex justify-between items-center py-4 px-6 bg-white border-b-4 border-indigo-600">
        <div className="flex items-center">
          <img className="h-8 w-auto mr-2" src="/next.svg" alt="Logo" />
            <h1 className="text-2xl px-20 font-semibold text-gray-800">Book API</h1>
        </div>
        <div className="flex items-center">
          <button className="mx-4 text-gray-600 hover:text-gray-800">/api/status</button>
          <button className="mx-4 text-gray-600 hover:text-gray-800">/api/orders</button>
          <button className="mx-4 text-gray-600 hover:text-gray-800">/api/books</button>
          <button className="mx-4 text-gray-600 hover:text-gray-800">/api/api-client</button>
